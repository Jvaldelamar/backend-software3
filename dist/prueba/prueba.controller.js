...
let PruebaController = class PruebaController {
    ...
    async crearPrueba(body) {
        return this.pruebaService.crearPrueba(body);
    }
    async obtenerPruebas() {
        return this.pruebaService.obtenerPruebas();
    }
};
...
], PruebaController.prototype, "crearPrueba", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PruebaController.prototype, "obtenerPruebas", null);
