...
let ComentariosController = class ComentariosController {
    ...
    async crearComentario(createComentarioDto) {
        return this.comentariosService.crearComentario(createComentarioDto);
    }
    async obtenerComentariosPorArchivo(archivoId) {
...
__decorate([
    (0, common_1.Get)(':archivoId'),
    __param(0, (0, common_1.Param)('archivoId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ComentariosController.prototype, "obtenerComentariosPorArchivo", null);
